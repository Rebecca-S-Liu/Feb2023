...
--4. do not use temp tables in stored procedures or user defined functions, but we can use table varialbes in sp or udf
...
--need to create a conjunction table in between 
